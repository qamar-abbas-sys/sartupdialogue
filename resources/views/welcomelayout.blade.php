...
<body>
    ...
    <header class="header text-center">	    
	    <h1 class="blog-name pt-lg-4 mb-0">Fijeh Roseline AAdum`s Podcast</h1>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				<div class="profile-section pt-3 pt-lg-0">
				    <img class="profile-image mb-3 rounded-circle mx-auto" src="/imgs/owner.jpg" alt="image" >			
					
					<div class="bio mb-3">Hi, My name is Fijeh Roseline AAdum, I am a Business Enthusiast, Social Entrepreneur, Investor, Best selling Author.<br>I am Founder of <a href="Immigrantsthrive.com">Immigrantsthrive.com</a></br><a href="frafoundation.com">frafoundation.com</a> And startup dialogue podcast.</div><!--//bio-->
				...
				<ul class="navbar-nav flex-column text-left">
					...
					<li class="nav-item">
					    <a class="nav-link" href="home"><i class="fas fa-bookmark fa-fw mr-2"></i>Blog Post</a>
					</li>
					<li class="nav-item">
    ...
    <footer class="footer text-center py-2 theme-bg-dark">
	        ...
	        <!--/* This template is released under the Creative Commons Attribution 3.0 License. Please keep the attribution link below when using for your own project. Thank you for your support. :) If you'd like to use the template without the attribution, you can buy the commercial license via our website: themes.3rdwavemedia.com */-->
                <small class="copyright">Powered By <i class="fas fa-heart" style="color: #fb866a;"></i>Smart Tech Team.</small>
